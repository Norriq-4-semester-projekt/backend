...
namespace WorkerService
{
    public static class SpikeDetection<T> where T : class
    {
        ...
        public static (bool, List<T>) DetectSpikeAsync(T latestData, List<T> trainingData, int startSpikes)
        {
            ...
            var estimator = mlContext.Transforms.DetectIidSpike(outputColumnName: nameof(Predictions.Prediction), inputColumnName: "Value", confidence: 98, pvalueHistoryLength: size / 4);
